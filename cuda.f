...
* generation of initial distribution of vortons Begin
	...
	call Random_number(xxx)		   ! Any generator of random numbers Uniform within the range [0,1]
	call Random_number(yyy)
	call Random_number(zzz)
	Vortex(ivorton,1)=xxx
	Vortex(ivorton,2)=yyy
	Vortex(ivorton,3)=zzz

 	call Random_number(Omega_x)
	call Random_number(Omega_y)
	call Random_number(Omega_z)
